...
import collections from "../components/asests/CollectionsMost"
...
const Collections = () => {
  return (
    ...
    <p className='text-black font-bold text-2xl'>Best Collections Salles </p>
    <hr className=' border-t-2 w-64 mx-auto border-black ' />
  </div>
